...
<section class="hero">
    ...
    <div class="container">
        <div class="hero-content about-section">
            <h2>Joint Masters Program (JMP)</h2>
        </div>
    </div>
</section>
<section class="phd-table-section">
    <div class="container">
        <ul>
            <li>
                <p>Energy Systems (IITM-Kathmandu University)</p>
            </li>
            <li>
                <p>Sustainable Energy Systems (IITM-University of Birmingham)</p>
            </li>
            <li>
                <p>Sustainable Engineering (IITM-Swansea University)</p>
            </li>
            <li>
                <p>Materials and Manufacturing (IITM-Swansea University)</p>
            </li>
        </ul>
    </div>
</section>
