...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Batch is a select (dropdown value), keep it plain — no need for Base64
    $batch        = trim($_POST['batch'] ?? '');
    $new_batch    = reconstructChunks('new_batch');

    // Base64-chunked text fields
    ...
    */
    ...
    if ($error === '') {
        ...
        try {
            ...
            header('Location: ms.php?success=added');
            exit;
...
<div class="dashboard-content">
    ...
    <div class="page-header">
        ...
        <div>
            <h1>Add M.S. Student</h1>
            <p>Add a new M.S. student to the database.</p>
        </div>

        <a href="ms.php" class="btn-add">
            <i class="fas fa-arrow-left"></i>
            Back to M.S. Students
        </a>
    ...
    <div class="dashboard-card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="" id="msForm" onsubmit="return prepareSubmit()">


                <!-- Batch (plain dropdown, no Base64) -->
                ...
                <div class="form-actions">
                    ...
                    <a href="ms.php" class="btn-cancel">
                        Cancel
                    </a>
