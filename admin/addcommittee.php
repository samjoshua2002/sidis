...
| FORM DEFAULTS
|--------------------------------------------------------------------------
| Unique variable names to avoid clashes with header.php's
| navigation loop (which uses $pageTitle but historically $title).
*/
    ...
    */
    ...
    if ($error === '') {
        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO advisory_committee
                (name, designation)
                VALUES (?, ?)
            ");
            ...
            header('Location: committee.php?success=added');
            exit;

        } catch (PDOException $e) {

            error_log("DB Error: " . $e->getMessage());
            $error = 'Unable to add the committee member. Please try again.';
...
<div class="dashboard-content">
    ...
    <div class="page-header">
        <div>
            ...
            <p>Add a new member to the advisory committee.</p>
        </div>
    </div>
    ...
    <div class="dashboard-card">
        ...
        <div class="card-header">
            <div>
                ...
                <p>Enter the member's name and designation.</p>
            </div>
        </div>
