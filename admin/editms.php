...
$mentor_1     = $student['mentor_1'];
$mentor_2     = $student['mentor_2'];
$new_batch    = '';
    ...
    */
    ...
    if ($error === '') {
        ...
        try {
            ...
            header('Location: ms.php?success=updated');
            exit;

        } catch (PDOException $e) {

            error_log("DB Error: " . $e->getMessage());
            $error = 'Unable to update the student. Please try again.';
...
<div class="dashboard-content">
    ...
    <div class="page-header">
        ...
        <div>
            <h1>Edit M.S. Student</h1>
            <p>Update the M.S. student details.</p>
        </div>
    ...
    <div class="dashboard-card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="?id=<?= $id ?>" id="msForm" onsubmit="return prepareSubmit()">
